...
}  transform: scale(1.04);  background: var(--primary-green);#cartModal button:hover {}  transition: background 0.2s, transform 0.2s;  box-shadow: 0 2px 8px rgba(91,106,77,0.08);  cursor: pointer;  font-size: 1rem;  border-radius: 8px;  border: none;  font-weight: 600;  color: #fff;  background: linear-gradient(90deg, var(--primary-green) 60%, var(--secondary-green) 100%);
  transform: none;    opacity: 1;  to {@keyframes fadeInUp {.products-grid .product-card:nth-child(4) { animation-delay: 0.26s; }.products-grid .product-card:nth-child(3) { animation-delay: 0.19s; }.products-grid .product-card:nth-child(2) { animation-delay: 0.12s; }.products-grid .product-card:nth-child(1) { animation-delay: 0.05s; }}  animation: fadeInUp 0.7s cubic-bezier(.4,2,.6,1) forwards;  transform: translateY(30px);  opacity: 0;.products-grid .product-card {}}
.product-card { position: relative; }
